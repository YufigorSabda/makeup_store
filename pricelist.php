	...
	" alt="Image" height="70" width="150" />
			...
			<td align="center" width="900" bgcolor="#FFF0F5">
                ...
                <tr>
                  ...
                  <td> 
					<a href='pricelist_detail.php?id=" . $data['id'] . "' type='button' class='btn btn-primary'>Detail</a>
                    <a href='update.php?id=" . $data["id"] . "' type='button' class='btn btn-success'>Update</a>
                    <a href='pricelist_delete.php?id=" . $data["id"] . "' type='button' class='btn btn-danger' onlick='return confirm('Yakin ingin menghapus data?')'>Delete</a>
                  </td>
                </tr>  
              ";
								}
