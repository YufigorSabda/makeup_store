...
<body body background="background.png"><br>
	...
	" alt="Image" height="70" width="150" />
			...
			<td align="center" width="900" bgcolor="#FFF0F5">
				<font size="+5">HALAMAN REGISTRASI</font> <br>
				<form action="#" method="get">
					<table width="10%" align="center" cellspacing="1" cellpadding="5">
						<tr>
						...
						<tr>
							<td>Alamat</td>
							<td>:<textarea name="alamat" cols="20px" rows="5px"></textarea></td>
						</tr>
						<tr>
							<td>Jenis Kelamin</td>
						...
						<tr>
							<td>Hobby</td>
							<td>:<input type="checkbox" name="hobby" value="g">g
						...
						<tr>
							<td>Pesan</td>
							<td>:<textarea name="pesan" cols="20px" rows="5px"></textarea></td>
						</tr>
						<tr>
