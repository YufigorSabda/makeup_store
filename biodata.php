...
<body body background="background.png"><br>
	...
	" alt="Image" height="70" width="150" />
			...
			<td align="center" width="900" bgcolor="#FFF0F5">
				<font size="+10">BIODATA PENJUAL</font> <br>
				<p>Nama : Yunanda Ayu Avriliana</p>
				<p>Umur : 19 tahun</p>
				<P>alamat : Campurejo Krajan RT 02/RW01, Kecamatan Boja, Kabupaten Kendal</P>
				<p>Email : yunandaayuauriliana@gmail.com</p>
				<p>Nomor HP : 081228961723</p>
